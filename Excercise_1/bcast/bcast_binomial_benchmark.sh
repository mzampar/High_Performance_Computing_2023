...
out_csv="/u/dssc/mzampar/hpc_project/Excercise_1/bcast/results/bcast_binomial.csv"
...
for map in $map_values; do
  for np in $np_values; do
    ...
    mpirun -np $np -map-by $map --mca coll_tuned_use_dynamic_rules true --mca coll_tuned_bcast_algorithm 6 ${src_path}osu_bcast -x 1000 -i 10000 | tail -n 21 \
